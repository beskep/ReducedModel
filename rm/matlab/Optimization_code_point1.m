...
load 'Initial_matrix_data_point1.mat'
...
To = ones(length(C), 1) * 10; %Function code에서 부재 초기온도조건 필요하기 때문에 작성
M1 = zeros(1, timestep); %Function code에서 대상 표면 1의 온도를 받기 위한 용도
...
f = @FUNCTION_code_point1; % 여기서부터 FUNCTION_code_point1 으로 넘어감
